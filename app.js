...
const RESTAURANT_REGIONS = [
  ...
  {id:'de', flag:'🇩🇪', label:'독일 (드레스덴 · 뮌헨 · 퓌센 · 린다우)', langCode:'de-DE'},
  {id:'at', flag:'🇦🇹', label:'오스트리아 (브레겐츠 · 보덴호수)', langCode:'de-AT'},
  {id:'ch', flag:'🇨🇭', label:'스위스 (취리히 · 아펜첼)', langCode:'de-CH'},
  {id:'li', flag:'🇱🇮', label:'리히텐슈타인 (파두츠)', langCode:'de-CH'},
];
...
const RESTAURANT_INTRO = {
  ...
  de: [
    {kr:'안녕하세요. 저희는 3명입니다. 자리가 있나요?', local:'Guten Tag. Wir sind drei Personen. Haben Sie einen freien Tisch?'},
    {kr:'3명 자리를 예약한 Kwon 이라고 합니다. 안내를 부탁합니다.', local:'Guten Tag, ich habe eine Reservierung auf den Namen Kwon für drei Personen.'},
    {kr:'메뉴판 좀 부탁드립니다.', local:'Könnten Sie mir die Speisekarte bringen, bitte?'},
    {kr:'혹시 추천해 주실 메뉴가 있나요?', local:'Könnten Sie mir etwas empfehlen?'},
    {kr:'조금 이따가 다시 볼게요, 아직 고르는 중이에요.', local:'Wir schauen uns noch kurz um, danke.'},
    {kr:'주문할게요.', local:'Können wir bestellen, bitte?'},
    {kr:'아이가 먹을 만한 메뉴가 있나요?', local:'Haben Sie ein Menü für Kinder?'},
    {kr:'화장실 어디 있어요?', local:'Wo sind die Toiletten?'},
    {kr:'여기 와이파이 있나요?', local:'Gibt es hier Wi-Fi?'},
  ],
  at: [
    {kr:'안녕하세요. 저희는 3명입니다. 자리가 있나요?', local:'Grüß Gott. Wir sind drei Personen. Haben Sie einen freien Tisch?'},
    {kr:'3명 자리를 예약한 Kwon 이라고 합니다. 안내를 부탁합니다.', local:'Grüß Gott, ich habe eine Reservierung auf den Namen Kwon für drei Personen.'},
    {kr:'메뉴판 좀 부탁드립니다.', local:'Könnten Sie mir die Speisekarte bringen, bitte?'},
    {kr:'혹시 추천해 주실 메뉴가 있나요?', local:'Könnten Sie mir etwas empfehlen?'},
    {kr:'조금 이따가 다시 볼게요, 아직 고르는 중이에요.', local:'Wir schauen uns noch kurz um, danke.'},
    {kr:'주문할게요.', local:'Können wir bestellen, bitte?'},
    {kr:'아이가 먹을 만한 메뉴가 있나요?', local:'Haben Sie ein Menü für Kinder?'},
    {kr:'화장실 어디 있어요?', local:'Wo sind die Toiletten?'},
    {kr:'야외(테라스)에 앉을 수 있나요?', local:'Können wir draußen sitzen?'},
  ],
  ch: [
    {kr:'안녕하세요. 저희는 3명입니다. 자리가 있나요?', local:'Grüezi. Wir sind drei Personen. Haben Sie einen freien Tisch?'},
    {kr:'3명 자리를 예약한 Kwon 이라고 합니다. 안내를 부탁합니다.', local:'Grüezi, ich habe eine Reservierung auf den Namen Kwon für drei Personen.'},
    {kr:'메뉴판 좀 부탁드립니다.', local:'Könnten Sie mir die Speisekarte bringen, bitte?'},
    {kr:'혹시 추천해 주실 메뉴가 있나요?', local:'Könnten Sie mir etwas empfehlen?'},
    {kr:'조금 이따가 다시 볼게요, 아직 고르는 중이에요.', local:'Wir schauen uns noch kurz um, danke.'},
    {kr:'주문할게요.', local:'Können wir bestellen, bitte?'},
  ...
  li: [
    ...
    {kr:'3명 자리를 예약한 Kwon 이라고 합니다. 안내를 부탁합니다.', local:'Grüezi, ich habe eine Reservierung auf den Namen Kwon für drei Personen.'},
    {kr:'메뉴판 좀 부탁드립니다.', local:'Könnten Sie mir die Speisekarte bringen, bitte?'},
    {kr:'리히텐슈타인 전통 음식은 뭔가요?', local:'Was ist typisch für Liechtenstein?'},
    {kr:'조금 이따가 다시 볼게요, 아직 고르는 중이에요.', local:'Wir schauen uns noch kurz um, danke.'},
    {kr:'주문할게요.', local:'Können wir bestellen, bitte?'},
    {kr:'화장실 어디 있어요?', local:'Wo sind die Toiletten?'},
  ],
...
const RESTAURANT_FOOD = {
  ...
  de: [
    {id:'schweinshaxe', emoji:'🍖', kr:'슈바인학센 (독일식 족발 구이)', en:'PORK KNUCKLE', local:'Schweinshaxe', desc:'겉은 바삭, 속은 부드러움. 자우어크라우트·크뇌델 곁들임. 2인이 나눠 먹기 좋음.', price:'약 16~22유로', recommend:'Augustiner an der Frauenkirche (드레스덴)'},
    {id:'schnitzel', emoji:'🍗', kr:'슈니첼 (독일식 돈까스)', en:'SCHNITZEL', local:'Schnitzel', desc:'빵가루 입혀 튀긴 커틀릿, 감자튀김/감자샐러드와 함께.', price:'약 13~19유로', recommend:'Gänsedieb(드레스덴), Olympia Alm(뮌헨)'},
    {id:'bratwurst', emoji:'🌭', kr:'브라트부어스트 (구운 소시지)', en:'BRATWURST', local:'Bratwurst', desc:'겨자 찍어 빵과 함께 먹는 독일 전역의 구운 소시지.', price:'약 3~6유로 (길거리)', recommend:''},
    {id:'weisswurst', emoji:'⚪', kr:'바이스부어스트 (뮌헨식 흰 소시지)', en:'WEISSWURST', local:'Weißwurst', desc:'뮌헨 대표 아침 메뉴, 달콤한 겨자·브레첼과 함께.', price:'약 6~10유로 (2개)', recommend:''},
    {id:'currywurst', emoji:'🍛', kr:'커리부어스트 (커리 소시지)', en:'CURRYWURST', local:'Currywurst', desc:'케첩+커리가루 소스를 얹은 독일 국민 길거리 음식.', price:'약 4~7유로', recommend:''},
    {id:'brezel', emoji:'🥨', kr:'브레첼 (매듭 모양 빵)', en:'PRETZEL', local:'Brezel', desc:'짭짤하고 쫄깃한 독일 전통 빵, 버터 발라 먹는 Butterbrezel도 인기.', price:'약 2~4유로', recommend:''},
    {id:'kartoffelpuffer', emoji:'🥔', kr:'카르토펠푸퍼 (감자전)', en:'POTATO PANCAKE', local:'Kartoffelpuffer', desc:'감자전, 사과소스를 곁들여 달콤 짭짤하게.', price:'약 3~6유로', recommend:''},
    {id:'stollen', emoji:'🍞', kr:'슈톨렌 & 콰르크벨헨', en:'STOLLEN / QUARK BALLS', local:'Dresdner Stollen / Quarkbällchen', desc:'드레스덴 명물 과일빵과 크림치즈 튀김 도넛.', price:'슈톨렌 약 3~5유로 / 콰르크벨헨 약 4~6유로', recommend:''},
  ],
  at: [
    {id:'wienerschnitzel', emoji:'🍗', kr:'비너 슈니첼', en:'WIENER SCHNITZEL', local:'Wiener Schnitzel', desc:'오스트리아 국민 요리, 얇게 편 고기를 버터에 튀겨냄. 감자샐러드 곁들임.', price:'약 16~24유로', recommend:''},
    {id:'tafelspitz', emoji:'🍲', kr:'타펠슈피츠', en:'TAFELSPITZ', local:'Tafelspitz', desc:'소고기 우둔살을 뿌리채소와 오래 삶은 요리, 합스부르크 황실 요리로도 유명.', price:'약 20~28유로', recommend:''},
    {id:'kaesspaetzle', emoji:'🧀', kr:'케제슈페츨레 (포어아를베르크 명물)', en:'KÄSSPÄTZLE', local:'Kässpätzle', desc:'슈페츨레(수제 파스타)에 산악 치즈를 듬뿍 녹인 브레겐츠 향토 음식.', price:'약 14~20유로', recommend:'브레겐츠 · 포어아를베르크'},
    {id:'felchen', emoji:'🐟', kr:'보덴호수 생선요리 (펠헨)', en:'LAKE CONSTANCE FISH', local:'Bodensee-Felchen', desc:'보덴호수산 흰살생선을 버터에 구운 지역 특선 요리.', price:'약 22~30유로', recommend:'Restaurant Reutemann(린다우)'},
    {id:'kaiserschmarrn', emoji:'🥞', kr:'카이저슈마른', en:'KAISERSCHMARRN', local:'Kaiserschmarrn', desc:'잘게 찢어 캐러멜라이즈한 오스트리아식 팬케이크, 자두잼 곁들임.', price:'약 12~18유로', recommend:''},
    {id:'sachertorte', emoji:'🍫', kr:'자허토르테', en:'SACHERTORTE', local:'Sachertorte', desc:'살구잼 층이 든 오스트리아 대표 초콜릿 케이크, 휘핑크림과 함께.', price:'조각당 약 6~9유로', recommend:''},
    {id:'apfelstrudel', emoji:'🥮', kr:'아펠슈트루델', en:'APFELSTRUDEL', local:'Apfelstrudel', desc:'계피향 사과 필링을 넣고 구운 대표 디저트, 바닐라소스와 함께.', price:'약 6~10유로', recommend:''},
    {id:'melange', emoji:'☕', kr:'멜랑주 & 비엔나 커피 문화', en:'MELANGE / COFFEE HOUSE', local:'Wiener Melange', desc:'우유거품 얹은 오스트리아식 카페라떼, 유네스코 무형문화유산 커피하우스 문화.', price:'약 4~6유로', recommend:''},
  ],
  ch: [
    {id:'kaesefondue', emoji:'🫕', kr:'치즈 퐁뒤', en:'CHEESE FONDUE', local:'Käsefondue', desc:'그뤼에르·에멘탈 치즈를 화이트와인과 녹여 빵을 찍어먹는 스위스 대표 요리.', price:'1인분 약 28~35 CHF', recommend:''},
    {id:'raclette', emoji:'🔥', kr:'라클렛', en:'RACLETTE', local:'Raclette', desc:'녹인 치즈를 긁어 감자·피클·양파와 함께 먹는 요리.', price:'1인분 약 26~34 CHF', recommend:''},
    {id:'geschnetzeltes', emoji:'🍛', kr:'취리히식 게슈네첼테스', en:'ZÜRCHER GESCHNETZELTES', local:'Zürcher Geschnetzeltes', desc:'얇게 썬 고기와 버섯을 크림소스에 볶은 취리히 향토 요리, 뢰스티와 함께.', price:'약 32~42 CHF', recommend:'취리히 구시가지'},
    {id:'roesti', emoji:'🥔', kr:'뢰스티', en:'RÖSTI', local:'Rösti', desc:'채 썬 감자를 노릇하게 구운 스위스식 감자전.', price:'단품 약 12~18 CHF', recommend:''},
    {id:'aelplermagronen', emoji:'🧀', kr:'알플러마그로넨', en:'ÄLPLERMAGRONEN', local:'Älplermagronen', desc:'마카로니+감자+치즈크림을 볶고 튀긴 양파를 올린 산악 요리.', price:'약 22~28 CHF', recommend:''},
    {id:'appenzeller', emoji:'🧈', kr:'아펜첼 치즈', en:'APPENZELLER CHEESE', local:'Appenzeller Käse', desc:'허브·와인 양념액에 숙성시킨 스위스 4대 치즈 중 하나.', price:'100g당 약 4~6 CHF', recommend:'Appenzeller Schaukäserei'},
    {id:'stgaller', emoji:'🌭', kr:'장크트갈렌 소시지', en:'ST. GALLER BRATWURST', local:'St. Galler Bratwurst', desc:'겨자 없이 먹는 것이 정통인 흰 송아지고기 소시지.', price:'약 6~9 CHF', recommend:''},
    {id:'lindt', emoji:'🍫', kr:'린트 초콜릿 & 스위스 디저트', en:'SWISS CHOCOLATE', local:'Lindt Schokolade', desc:'취리히 인근 린트 홈 오브 초콜릿에서 제조 견학·시식 가능.', price:'', recommend:'Lindt Home of Chocolate'},
  ],
  li: [
    {id:'kaesknoepfle', emoji:'🧀', kr:'케제뇌펠레 (국민 요리)', en:'KÄSKNÖPFLE', local:'Käsknöpfle', desc:'작은 경단에 산악 치즈를 듬뿍 얹고 튀김양파를 올린 리히텐슈타인 국민 요리.', price:'약 20~28 CHF', recommend:'여관(Gasthaus)에서 다같이 나눠먹는 대표 요리'},
    {id:'ribel', emoji:'🌽', kr:'리벨 (옥수수 죽/구움 요리)', en:'RIBEL', local:'Ribel', desc:'옥수수가루를 우유에 끓여 버터에 구운 전통 아침·간식.', price:'약 12~18 CHF', recommend:''},
    {id:'torkarebl', emoji:'🥧', kr:'토르카레블', en:'TORKAREBL', local:'Torkarebl', desc:'가을 수확철 즐기는 걸쭉한 옥수수 요리, 햇와인과 함께.', price:'약 15~20 CHF', recommend:'가을 계절 메뉴'},
    {id:'hafalaab', emoji:'🍜', kr:'하팔라프', en:'HAFALAAB', local:'Hafalaab', desc:'경단·슈페츨레·뇨끼 특징을 섞은 희소한 향토 요리.', price:'약 16~22 CHF', recommend:'전문 향토 레스토랑에서만 취급'},
    {id:'groestl', emoji:'🍳', kr:'그뢰스틀', en:'GRÖSTL', local:'Gröstl', desc:'감자·양파·남은 고기를 볶고 달걀프라이를 올린 투박한 팬 요리.', price:'약 18~24 CHF', recommend:''},
    {id:'alpkaese', emoji:'🧈', kr:'산악 치즈', en:'ALPKÄSE', local:'Alpkäse', desc:'고산 목초지 소 우유로 만든 리히텐슈타인 산악 치즈.', price:'100g당 약 4~7 CHF', recommend:''},
    {id:'fasnachtskuachle', emoji:'🍩', kr:'파스나흐트퀴아흘레 (튀김 도넛)', en:'FASNACHTSKÜACHLE', local:'Fasnachtsküachle', desc:'설탕 뿌린 바삭한 전통 튀김과자.', price:'개당 약 2~4 CHF', recommend:''},
    {id:'dreikoenigskuchen', emoji:'👑', kr:'드라이쾨니히스쿠헨 (왕의 케이크)', en:'DREIKÖNIGSKUCHEN', local:'Dreikönigskuchen', desc:'주현절 시즌 한정, 반죽 속 인형을 찾으면 "왕"이 되는 전통 빵.', price:'조각당 약 3~5 CHF', recommend:'겨울 한정'},
  ],
};

// 각 음료류 (지역 특산 알코올) + 무알콜/학생용 음료(사용자 요청으로 전 지역 공통 추가)
const RESTAURANT_DRINK = {
  cz: [
    ...
    {id:'nealko_pivo', emoji:'🚫🍺', kr:'무알콜 맥주', en:'Alcohol-free beer', local:'Nealkoholické pivo', desc:'운전자나 아이와 함께라면 이걸로. 최근 체코에서도 종류가 다양해짐.', price:'약 35~55 CZK', recommend:''},
    {id:'kofola', emoji:'🥤', kr:'코폴라 (체코 국민 콜라)', en:'Kofola', local:'Kofola', desc:'콜라보다 덜 달고 허브향이 있는 체코의 국민 탄산음료, 아이·학생도 즐겨 마심.', price:'약 30~45 CZK', recommend:''},
  ],
  de: [
    {id:'helles', emoji:'🍺', kr:'헬레스 (맑은 라거)', en:'Helles', local:'Helles', desc:'뮌헨을 중심으로 한 바이에른 대표 라거.', price:'0.5L 약 4~6유로', recommend:''},
    {id:'weissbier', emoji:'🍻', kr:'바이스비어 (밀맥주)', en:'Weißbier', local:'Weißbier', desc:'바나나·정향 향이 나는 부드러운 밀맥주.', price:'0.5L 약 4~6유로', recommend:''},
    {id:'gluehwein', emoji:'🍷', kr:'글뤼바인', en:'Glühwein', local:'Glühwein', desc:'계피·정향·오렌지를 넣고 데운 겨울 상징 와인.', price:'약 3~5유로', recommend:''},
    {id:'schnaps', emoji:'🥃', kr:'슈냅스', en:'Schnaps', local:'Schnaps', desc:'과일을 증류한 독한 술, 식후 소화용.', price:'샷 약 3~6유로', recommend:''},
    {id:'alkoholfrei_bier', emoji:'🚫🍺', kr:'무알콜 맥주', en:'Alcohol-free beer', local:'Alkoholfreies Bier', desc:'독일 어디서나 쉽게 구할 수 있는 무알콜 맥주, 종류도 다양.', price:'0.5L 약 3~5유로', recommend:''},
    {id:'apfelschorle', emoji:'🍎', kr:'아펠쇼얼레 (사과탄산음료)', en:'Apfelschorle', local:'Apfelschorle', desc:'사과주스+탄산수를 섞은 독일 국민 음료, 아이·학생·어른 모두 즐김.', price:'약 3~4유로', recommend:''},
  ],
  at: [
    {id:'almdudler', emoji:'🥤', kr:'알름두들러', en:'Almdudler', local:'Almdudler', desc:'"오스트리아의 콜라"로 불리는 국민 허브 탄산음료. 학생·아이 모두 즐겨 마심(이미 무알콜).', price:'약 3~4유로', recommend:''},
    {id:'radler', emoji:'🍺', kr:'라들러', en:'Radler', local:'Radler', desc:'맥주에 레몬 탄산음료를 섞은 저도수 음료.', price:'약 4~6유로', recommend:''},
    {id:'gruenerveltliner', emoji:'🍷', kr:'그뤼너 벨트리너 (화이트와인)', en:'Grüner Veltliner', local:'Grüner Veltliner', desc:'오스트리아 대표 화이트와인 품종.', price:'', recommend:''},
    {id:'alkoholfrei_bier_at', emoji:'🚫🍺', kr:'무알콜 맥주', en:'Alcohol-free beer', local:'Alkoholfreies Bier', desc:'오스트리아에서도 흔히 볼 수 있는 무알콜 맥주.', price:'약 3~5유로', recommend:''},
  ],
  ch: [
    {id:'rivella', emoji:'🥤', kr:'리벨라 (스위스 국민 음료)', en:'Rivella', local:'Rivella', desc:'우유 유청으로 만든 스위스 국민 탄산음료, 학생·아이도 즐겨 마심(이미 무알콜).', price:'약 3~5 CHF', recommend:''},
    {id:'alpenbitter', emoji:'🥃', kr:'알펜비터', en:'Appenzeller Alpenbitter', local:'Appenzeller Alpenbitter', desc:'42가지 알프스 허브로 만든 아펜첼 전통 리큐르.', price:'샷 약 5~7 CHF', recommend:''},
    {id:'alkoholfrei_bier_ch', emoji:'🚫🍺', kr:'무알콜 맥주', en:'Alcohol-free beer', local:'Alkoholfreies Bier', desc:'스위스 어디서나 쉽게 볼 수 있는 무알콜 맥주.', price:'약 4~6 CHF', recommend:''},
  ],
  li: [
    {id:'vaduzerwein', emoji:'🍷', kr:'파두츠 와인 (군주가의 포도밭)', en:'Vaduzer Wein', local:'Vaduzer Wein', desc:'리히텐슈타인 군주 가문 소유 포도밭에서 생산하는 희소한 와인.', price:'글라스 약 8~14 CHF', recommend:''},
    {id:'holdersaft', emoji:'🍯', kr:'홀더자프트 (엘더베리 잼/주스)', en:'Holdersaft', local:'Holdersaft', desc:'검은 엘더베리로 만든 새콤달콤한 전통 잼·주스, 물에 희석해 마시면 무알콜 음료로 학생·아이도 즐길 수 있음.', price:'병당 약 6~10 CHF', recommend:''},
    {id:'alkoholfrei_bier_li', emoji:'🚫🍺', kr:'무알콜 맥주', en:'Alcohol-free beer', local:'Alkoholfreies Bier', desc:'파두츠 레스토랑에서도 쉽게 찾을 수 있는 무알콜 맥주.', price:'', recommend:''},
  ],
};
...
const RESTAURANT_ETC = {
  ...
  de: [
    {cat:'물 / 옵션', kr:'탄산 없는 물 주세요.', local:'Stilles Wasser, bitte.'},
    {cat:'물 / 옵션', kr:'크림 빼주세요.', local:'Ohne Sahne.'},
    {cat:'물 / 옵션', kr:'설탕 빼주세요.', local:'Ohne Zucker.'},
    {cat:'물 / 옵션', kr:'포크 좀 더 갖다 주시겠어요?', local:'Können Sie mir eine Gabel bringen?'},
    {cat:'맛 표현', kr:'맛있네요.', local:'Schmeckt gut.'},
    {cat:'맛 표현', kr:'그거 정말 맛있었어요.', local:'Das war super lecker.'},
    {cat:'포장', kr:'포장할게요.', local:'Zum Mitnehmen.'},
    {cat:'포장', kr:'여기서 먹을게요.', local:'Zum Hieressen.'},
    {cat:'포장', kr:'남은 음식 좀 싸주시겠어요?', local:'Könnten Sie den Rest einpacken, bitte?'},
    {cat:'계산', kr:'계산할게요.', local:'Zahlen, bitte.'},
    {cat:'계산', kr:'같이 계산할게요.', local:'Zusammen, bitte.'},
    {cat:'계산', kr:'따로 계산할게요.', local:'Getrennt, bitte.'},
    {cat:'계산', kr:'카드로 계산할게요.', local:'Mit Karte, bitte.'},
    {cat:'계산', kr:'현금으로 계산할게요.', local:'Bar, bitte.'},
    {cat:'계산', kr:'잔돈은 괜찮아요.', local:'Stimmt so.'},
    {cat:'계산', kr:'이거 얼마예요?', local:'Wie viel kostet das?'},
  ],
  at: [
    {cat:'물 / 옵션', kr:'탄산 없는 물 한 잔 주세요.', local:'Ein stilles Wasser, bitte.'},
    {cat:'물 / 옵션', kr:'크림 빼주세요.', local:'Ohne Sahne.'},
    {cat:'물 / 옵션', kr:'설탕 빼주세요.', local:'Ohne Zucker.'},
    {cat:'물 / 옵션', kr:'포크 좀 더 갖다 주시겠어요?', local:'Können Sie mir noch eine Gabel bringen?'},
    {cat:'맛 표현', kr:'정말 맛있네요.', local:'Das schmeckt ausgezeichnet.'},
    {cat:'포장', kr:'포장할게요.', local:'Zum Mitnehmen.'},
    {cat:'포장', kr:'여기서 먹을게요.', local:'Zum Hieressen.'},
    {cat:'계산', kr:'계산할게요.', local:'Zahlen, bitte.'},
    {cat:'계산', kr:'같이 계산할게요.', local:'Zusammen, bitte.'},
    ...
    {cat:'계산', kr:'카드로 계산할게요.', local:'Mit Karte, bitte.'},
    {cat:'계산', kr:'현금으로 계산할게요.', local:'Bar, bitte.'},
    {cat:'계산', kr:'잔돈은 괜찮아요, 감사합니다.', local:'Stimmt so, danke.'},
    {cat:'계산', kr:'이거 얼마예요?', local:'Wie viel kostet das?'},
  ],
  ch: [
    {cat:'물 / 옵션', kr:'탄산 없는 물 주세요.', local:'Stilles Wasser, bitte.'},
    {cat:'물 / 옵션', kr:'크림 빼주세요.', local:'Ohne Sahne.'},
    {cat:'물 / 옵션', kr:'겨자 빼주세요.', local:'Ohne Senf.'},
    {cat:'물 / 옵션', kr:'포크 좀 더 갖다 주시겠어요?', local:'Können Sie mir eine Gabel bringen?'},
    {cat:'맛 표현', kr:'정말 맛있네요.', local:'Schmeckt sehr gut.'},
    {cat:'포장', kr:'포장할게요.', local:'Zum Mitnehmen.'},
    {cat:'포장', kr:'여기서 먹을게요.', local:'Zum Hieressen.'},
    {cat:'계산', kr:'계산할게요.', local:'Zahlen, bitte.'},
    {cat:'계산', kr:'같이 계산할게요.', local:'Zusammen, bitte.'},
    ...
    {cat:'계산', kr:'잔돈은 괜찮아요.', local:'Stimmt so.'},
    {cat:'계산', kr:'이거 얼마예요?', local:'Wie viel kostet das?'},
    {cat:'인사(작별)', kr:'감사합니다!', local:'Merci vielmal!'},
    {cat:'인사(작별)', kr:'안녕히 계세요!', local:'Auf Wiedersehen!'},
  ],
  li: [
    {cat:'물 / 옵션', kr:'탄산 없는 물 한 잔 주세요.', local:'Ein stilles Wasser, bitte.'},
    {cat:'물 / 옵션', kr:'양파 빼주세요.', local:'Ohne Zwiebeln.'},
    {cat:'물 / 옵션', kr:'치즈 빼주세요.', local:'Ohne Käse.'},
    {cat:'물 / 옵션', kr:'포크 좀 더 갖다 주시겠어요?', local:'Können Sie mir noch eine Gabel bringen?'},
    {cat:'맛 표현', kr:'정말 맛있네요.', local:'Das schmeckt hervorragend.'},
    {cat:'포장', kr:'포장할게요.', local:'Zum Mitnehmen.'},
    {cat:'포장', kr:'여기서 먹을게요.', local:'Zum Hieressen.'},
    {cat:'계산', kr:'계산할게요.', local:'Zahlen, bitte.'},
    {cat:'계산', kr:'같이 계산할게요.', local:'Zusammen, bitte.'},
    {cat:'계산', kr:'따로 계산할게요.', local:'Getrennt, bitte.'},
    {cat:'계산', kr:'카드로 계산할게요. (CHF만 통용, 유로는 안 될 수 있음)', local:'Mit Karte, bitte.'},
    {cat:'계산', kr:'잔돈은 괜찮아요, 감사합니다.', local:'Stimmt so, danke.'},
    {cat:'계산', kr:'이거 얼마예요?', local:'Wie viel kostet das?'},
  ],
};
